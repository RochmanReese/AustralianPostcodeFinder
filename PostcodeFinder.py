...
# time module for sleep function to wait 2 secons on exit
...
def goodbye():
    print('\n----------------------------------------------------------------------')
    print('Thanks for using the Australian Postcode Locator and Place Name Finder')
    print('----------------------------------------------------------------------\n')
...
def welcome():
    print('\n--------------------------------------------------------------------')
    print('Welcome to the the Australian Postcode Locator and Place Name Finder')
    print('--------------------------------------------------------------------\n')
    print('-----------------------------------------------------------------------------------------')
    print('Make sure Python3 is installed. Does not work with Python 2\n')
    
    print('Shows the Postcode for Australian Cities, Suburbs and Regional Place Names.')
    print('Shows the approximate Latitude and longitude for a given Postcode or Location')
    print('Shows how many other Locations in Australia also share the same Name and Postcode.')
...
# creates a string called map_link which uses lat and long values from csv file and concatenates into a single URL 
                    map_link = 'https://osmand.net/map/?pin=' + str(row[4]) +',' + str(row[5]) + '#5/' + str(row[4]) + '/' + str(row[5])
